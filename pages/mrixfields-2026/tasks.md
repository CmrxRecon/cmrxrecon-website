...
Please note that for all three tasks, the underlying dataset partitions are identical: about 1900+ unpaired cases (T1W, T2W, T2FLAIR) and 45 paired cases (3 paired volunteers × 5 fields × 3 modalities) released in full for training; 225 paired cases (15 volunteers × 5 fields × 3 modalities) held privately for validation, of which only the input scans are released to participants under a disjoint source-field split (each volunteer assigned to one source field, with the remaining field strengths withheld as paired ground truth); and 300 paired cases (20 held-out volunteers × 5 fields × 3 modalities) similarly held privately for testing. 
